...
*Currently these employer names have not yet been standardized, so this should be used only for awareness but not reporting rankings publicly.*
...
agencyteams %>% 
  select(namestring, most_recent_employment) %>% 
  distinct() %>% 
