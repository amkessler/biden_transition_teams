...
####
The following is an analysis based on scraping Joe Biden's presidential transition [website](https://buildbackbetter.gov/the-transition/agency-review-teams/) to capture the various lists of members on the Agency Review Teams.  
...
####
The **smallest** agency review teams (less than six members) as of today are:
...
agencyteams %>% 
  filter(str_detect(most_recent_employment_standardized, "CALIFORNIA")) %>% 
  arrange(name) %>% 
  write_csv("output/california.csv")
